...
const GROUP_MEMBERS = [
  { name: 'Ana', date: '7 de Abril', emoji: '👩' },
  { name: 'João', date: '18 de Maio', emoji: '🧑' },
  { name: 'Marina', date: '10 de Agosto', emoji: '👩‍🦰' },
];
          ...
          >
            <div className="relative aspect-square w-full">
              ...
              {ORBIT_AVATARS.map((avatar, idx) => (
                ...
                >
                  <div
                    className={`flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br ${avatar.bg} text-4xl shadow-soft border-4 border-card`}
                  >
